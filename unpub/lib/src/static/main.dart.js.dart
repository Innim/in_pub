...
\$.wh=null
\$.EG=A.m([".admin._ngcontent-%ID%{margin:24px 0 60px}.title._ngcontent-%ID%{font-size:24px;margin:0 0 12px}.hint._ngcontent-%ID%{color:#555;font-size:14px;max-width:75ch}a.btn._ngcontent-%ID%{display:inline-block;text-decoration:none}"],t.f)
\$.wi=null
